...
# [PASSAGE 16, 17] TicTacToeBoard 클래스 정의
TTB = namedtuple("TicTacToeBoard", "tup turn winner terminal")

class TicTacToeBoard(TTB, Node): # TTB의 속성들도 상속
...
# [PASSAGE 18, 19] 보조 함수 및 게임 실행 로직
...
def find_winner(tup): # X가 이기면 True, O가 이기면 False, 미종료 상태이면 None 반환
