...
# ==== NLTK : Entity Recognition (NER chunker) ==== #
...
# ==== Bidreactional-LSTM Implementation ==== # 
...
X_train, X_test, y_train, y_test = train_test_split(sentences, ner_tags, 
...
# MODEL IMPLEMENTATION : BIDIRECTIONAL LSTM
