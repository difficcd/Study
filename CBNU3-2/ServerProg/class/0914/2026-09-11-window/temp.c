...
// tid를 함께 들고 가려면 thread 자체도 묶여야 편함
// pthread_t * workers => WorkerInfo struct 에 통일
...
/* default thread 1, 2
	...
	pthread_t worker_1 ;   pthread_t worker_2 ;
...
void * worker_thread (void * arg)
{
	...
	while(1) {
		...
		// new thread starts 3 (1,2 default, and index : 0~)
